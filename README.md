# 📱 MindFlow - Telegram Mini App

**MindFlow** - это дневник настроения с AI-аналитикой и встроенными инструментами для учебы, предназначенный для школьников и студентов (13-25 лет).
